...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 439, 371))
        ...
        self.btnChooseArchive = QtWidgets.QPushButton(self.centralwidget)
        self.btnChooseArchive.setObjectName("btnChooseArchive")
        self.gridLayout.addWidget(self.btnChooseArchive, 1, 4, 1, 1)
        self.inputOpenArchive = QtWidgets.QLineEdit(self.centralwidget)
        self.inputOpenArchive.setObjectName("inputOpenArchive")
        self.gridLayout.addWidget(self.inputOpenArchive, 1, 0, 1, 4)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnChooseArchive.setText(_translate("MainWindow", "Choose Archive"))
